...
We also did spatiotemporal aggregations of mean cloud cover by month and flight box (Figure 4). In other words, we aggregated both spatially (all cells within the domain) and temporally (all days within the given month across all years).
...
#| fig.width: 10
#| fig.height: 20
#| fig.cap: "Figure 4. The full domain (light grey) and planned flight boxes, colored by mean monthly cloud cover.Numbers on flight boxes refer to mean cloud cover."
#| code-fold: true
