...
# To add to flight planning:
  ...
  #   
  #   1) add header with MODIS Cloud flags and a short description of where the cloud data come from (MOD09GA, etc.)
  ...
  # 5) Campaign simulations: add more details about the sampling algorithm - maybe as bullet points,
      # e.g. a) rank boxes by mean cloudiness,
            #b) on day 1, select the typically cloudiest box that's clear that day,
            #c) repeat.
            #This was done as a moving window for each day within the 3-month candidate campaign period october-december.
       # This plot shows the range of days required to capture all boxes across 2000-2021.  
  # 
